%Test - This works, as it is one of the accepted formats for GitHub, but I don't know if you could write any proper code using it.
...
%Issue with just copying and pasting into github is that it is no longr
%showing as MATLAB code, rather as just writing, and sometimes some code
%gets converted into emojis,etc. 
